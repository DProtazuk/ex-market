    ...
    <div class="my-content">
        ...
        <div class="col-12 content-body">
            <div class="myContainer mx-auto my-2">
                <form action="/backend/entry_system/registration" method="post">
                    <div class="col-5 rounded-3 bg-silver mx-auto my-5 p-5">
                        ...
                        <div class="col-12 my-4 mt-5 ">
                            ...
                            <div class="col-12 my-4">
                                ...
                                ?>" name="email" required placeholder="Email" class="input-auth px-3 text-white bg-silver col-12 text-14 py-1 rounded-2 border border-secondary" type="email"
                                       style=" outline:none;  ">
                                <?php
                            ...
                            <div class="col-12 my-4">
                                ...
                                ?>" name="password" required placeholder="Пароль" class="input-auth px-3 text-white bg-silver col-12 text-14 py-1 rounded-2 border border-secondary" type="text"
                                       style=" outline:none;  ">
                            </div>
                        ...
                        <div class="col-12 d-flex">
                            ...
                            <h6 class="text-14 mx-3">Я принимаю
                                <a class="text-decoration-none text_blue" href="/page/politics">пользовательское соглашение и
                        ...
                        <h6 class="text-14 my-3 text-center">Есть аккаунт? <a class="text-decoration-none text_blue" href="/page/unauthorized/authorization">Войти</a> </h6>
